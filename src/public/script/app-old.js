...
let App = function (key, temp) {
    ...
    this.getWeather = function () {
        ...
        var temp$ = new Promise((resolve, reject) => {
                ...
                this.url.searchParam.set("unit", this.temp.getUnits())
...
var bodyPart = document.documentElement.childNodes[2];
// Main part
var meteoDiv = document.getElementsByClassName("meteo-container");

var app = new App("APPID=b26dd00efbc7410a76d9b6d4e9272b6c", temp)
